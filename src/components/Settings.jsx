    ...
    <div style={styles.container}>
      <div style={styles.sidebar}>
        ...
        <div 
          ...
          className="sidebar-link"
        >
          <span style={{ color: '#475569' }}>📋</span> Отчеты
        </div>
        <div 
          style={styles.sidebarItem}
        ...
        <div 
          ...
          className="sidebar-link"
        >
          <span style={{ color: '#0284c7' }}>⚙️</span> Настройки
        </div>
      </div>
        ...
        <div style={styles.contentArea}>
          <div style={styles.placeholderCard}>
            ...
            <p style={styles.placeholderText}>
              Функционал настроек находится в стадии разработки. 
              Здесь будут доступны настройки уведомлений, параметры интеграций, 
              управление пользователями и другие административные функции.
            </p>
            <button 
